...
export type UnitDef = {
  name: string;
  shortName: string; // unique compact label for the canonical Math renderer
  race: Race;
  sprite: string;
...
const def = (d: Partial<UnitDef> & Pick<UnitDef, 'name' | 'shortName' | 'roles'>): UnitDef => ({
...
const gasBuilding = (race: Race, sprite: string, hp: number, shields = 0): Partial<UnitDef> & Pick<UnitDef, 'roles'> => ({
...
const terran = (sprite: string, d: Partial<UnitDef> & Pick<UnitDef, 'name' | 'shortName' | 'roles'>): UnitDef => def({ race: 'terran', sprite, ...d });
const protoss = (sprite: string, d: Partial<UnitDef> & Pick<UnitDef, 'name' | 'shortName' | 'roles'>): UnitDef => def({ race: 'protoss', sprite, ...d });
const zerg = (sprite: string, d: Partial<UnitDef> & Pick<UnitDef, 'name' | 'shortName' | 'roles'>): UnitDef => def({ race: 'zerg', sprite, ...d });
...
export const Units: Record<number, UnitDef> = {
  // Neutral resources.
  [Kind.Mineral]: def({
    name: 'Mineral Field', shortName: 'MIN', sprite: 'mineral', roles: Role.Resource, size: Size.Large,
    radius: fx(24), footprintW: 2, footprintH: 1, resourceType: ResourceType.Minerals,
  }),
  [Kind.Geyser]: def({
    name: 'Vespene Geyser', shortName: 'GAS', sprite: 'geyser', roles: 0, size: Size.Large, radius: fx(56),
    footprintW: 4, footprintH: 2, resourceType: ResourceType.Gas,
  }),

  // Terran units.
  [Kind.SCV]: terran('scv', {
    name: 'SCV', shortName: 'SCV', ...mobile(11), roles: Role.Mobile | Role.Worker, size: Size.Small,
  ...
  [Kind.Marine]: terran('marine', {
    name: 'Marine', shortName: 'MAR', ...mobile(8), size: Size.Small,
  ...
  [Kind.Firebat]: terran('firebat', {
    name: 'Firebat', shortName: 'FBAT', ...mobile(11), size: Size.Small,
  ...
  [Kind.Medic]: terran('medic', {
    name: 'Medic', shortName: 'MED', ...mobile(8), size: Size.Small,
  ...
  [Kind.Ghost]: terran('ghost', {
    name: 'Ghost', shortName: 'GHO', ...mobile(8), size: Size.Medium,
  ...
  [Kind.Vulture]: terran('vulture', {
    name: 'Vulture', shortName: 'VULT', ...mobile(16), size: Size.Small,
  ...
  [Kind.SiegeTank]: terran('siegeTank', {
    name: 'Siege Tank', shortName: 'ST', ...mobile(16), size: Size.Large,
  ...
  [Kind.SiegeTankSieged]: terran('siegeMode', {
    name: 'Siege Tank (Siege)', shortName: 'SIEG', ...mobile(16), size: Size.Large,
  ...
  [Kind.Goliath]: terran('goliath', {
    name: 'Goliath', shortName: 'GOL', ...mobile(16), size: Size.Large,
  ...
  [Kind.Wraith]: terran('wraith', {
    name: 'Wraith', shortName: 'WRA', ...air(19), size: Size.Large,
  ...
  [Kind.Dropship]: terran('dropship', {
    name: 'Dropship', shortName: 'DROP', ...air(24), size: Size.Large,
  ...
  [Kind.ScienceVessel]: terran('scienceVessel', {
    name: 'Science Vessel', shortName: 'VES', ...air(32), size: Size.Large,
  ...
  [Kind.Valkyrie]: terran('valkyrie', {
    name: 'Valkyrie', shortName: 'VALK', ...air(24), size: Size.Large,
  ...
  [Kind.Battlecruiser]: terran('battlecruiser', {
    name: 'Battlecruiser', shortName: 'BC', ...air(37), size: Size.Large,
  ...
  [Kind.SpiderMine]: terran('spiderMine', {
    name: 'Spider Mine', shortName: 'MINE', ...mobile(7), size: Size.Small,
  ...
  [Kind.NuclearMissile]: terran('nuclearMissile', {
    name: 'Nuclear Missile', shortName: 'NUKE', roles: 0, size: Size.Large,
    hp: 1, minerals: 200, gas: 200, buildTime: sec(37.8), buildMethod: 'internal',
  }),

  // Terran buildings.
  [Kind.CommandCenter]: terran('commandCenter', {
    name: 'Command Center', shortName: 'CC', ...structure(58, 4, 3), roles: depot(structure(58, 4, 3)),
  ...
  [Kind.SupplyDepot]: terran('supplyDepot', {
    name: 'Supply Depot', shortName: 'DEP', ...structure(38, 3, 2), size: Size.Large,
  ...
  [Kind.Refinery]: terran('refinery', {
    name: 'Refinery', shortName: 'REF', ...gasBuilding('terran', 'refinery', 750), size: Size.Large,
    armor: 1, sight: 8, minerals: 100, buildTime: sec(25.2),
  }),
  [Kind.Barracks]: terran('barracks', {
    name: 'Barracks', shortName: 'RAX', ...structure(52, 4, 3), roles: producer(structure(52, 4, 3)), size: Size.Large,
  ...
  [Kind.Factory]: terran('factory', {
    name: 'Factory', shortName: 'FAC', ...structure(56, 4, 3), roles: producer(structure(56, 4, 3)), size: Size.Large,
  ...
  [Kind.MachineShop]: terran('machineShop', {
    name: 'Machine Shop', shortName: 'SHOP', ...structure(36, 2, 2), size: Size.Large,
    hp: 750, armor: 1, sight: 8, minerals: 50, gas: 50, buildTime: sec(25.2), requires: [Kind.Factory],
    buildMethod: 'addon',
  }),
  [Kind.Starport]: terran('starport', {
    name: 'Starport', shortName: 'PORT', ...structure(48, 4, 3), roles: producer(structure(48, 4, 3)), size: Size.Large,
  ...
  [Kind.ControlTower]: terran('controlTower', {
    name: 'Control Tower', shortName: 'TOW', ...structure(38, 2, 2), size: Size.Large,
    hp: 500, armor: 1, sight: 8, minerals: 50, gas: 50, buildTime: sec(25.2), requires: [Kind.Starport],
    buildMethod: 'addon',
  }),
  [Kind.Armory]: terran('armory', {
    name: 'Armory', shortName: 'ARM', ...structure(48, 3, 2), size: Size.Large,
  ...
  [Kind.ScienceFacility]: terran('scienceFacility', {
    name: 'Science Facility', shortName: 'SCI', ...structure(48, 4, 3), size: Size.Large,
    hp: 850, armor: 1, sight: 10, minerals: 100, gas: 150, buildTime: sec(50.4), requires: [Kind.Starport],
  }),
  [Kind.PhysicsLab]: terran('physicsLab', {
    name: 'Physics Lab', shortName: 'PHY', ...structure(38, 2, 2), size: Size.Large,
  ...
  [Kind.CovertOps]: terran('covertOps', {
    name: 'Covert Ops', shortName: 'OPS', ...structure(38, 2, 2), size: Size.Large,
  ...
  [Kind.ComsatStation]: terran('comsatStation', {
    name: 'Comsat Station', shortName: 'COM', ...structure(38, 2, 2), size: Size.Large,
  ...
  [Kind.NuclearSilo]: terran('nuclearSilo', {
    name: 'Nuclear Silo', shortName: 'SILO', ...structure(38, 2, 2), roles: producer(structure(38, 2, 2)), size: Size.Large,
  ...
  [Kind.Probe]: protoss('probe', {
    name: 'Probe', shortName: 'PROB', ...mobile(11), roles: Role.Mobile | Role.Worker, size: Size.Small,
  ...
  [Kind.Zealot]: protoss('zealot', {
    name: 'Zealot', shortName: 'ZEAL', ...mobile(11), size: Size.Small,
  ...
  [Kind.Dragoon]: protoss('dragoon', {
    name: 'Dragoon', shortName: 'DRAG', ...mobile(16), size: Size.Large,
  ...
  [Kind.HighTemplar]: protoss('highTemplar', {
    name: 'High Templar', shortName: 'HT', ...mobile(12), size: Size.Small,
  ...
  [Kind.DarkTemplar]: protoss('darkTemplar', {
    name: 'Dark Templar', shortName: 'DT', ...mobile(12), size: Size.Small,
  ...
  [Kind.Archon]: protoss('archon', {
    name: 'Archon', shortName: 'ARCH', ...mobile(16), size: Size.Large,
  ...
  [Kind.DarkArchon]: protoss('darkArchon', {
    name: 'Dark Archon', shortName: 'DARC', ...mobile(16), size: Size.Large,
  ...
  [Kind.Reaver]: protoss('reaver', {
    name: 'Reaver', shortName: 'REAV', ...mobile(16), roles: Role.Mobile | Role.Producer, size: Size.Large,
  ...
  [Kind.Scarab]: protoss('scarab', {
    name: 'Scarab', shortName: 'SCAR', ...mobile(3), size: Size.Small,
  ...
  [Kind.Observer]: protoss('observer', {
    name: 'Observer', shortName: 'OBS', ...air(16), size: Size.Small,
  ...
  [Kind.Carrier]: protoss('carrier', {
    name: 'Carrier', shortName: 'CAR', ...air(32), roles: Role.Mobile | Role.Air | Role.Producer, size: Size.Large,
  ...
  [Kind.Interceptor]: protoss('interceptor', {
    name: 'Interceptor', shortName: 'INT', ...air(8), size: Size.Small,
  ...
  [Kind.Arbiter]: protoss('arbiter', {
    name: 'Arbiter', shortName: 'ARB', ...air(22), size: Size.Large,
  ...
  [Kind.Corsair]: protoss('corsair', {
    name: 'Corsair', shortName: 'COR', ...air(18), size: Size.Medium,
  ...
  [Kind.Nexus]: protoss('nexus', {
    name: 'Nexus', shortName: 'NEX', ...structure(56, 4, 3), roles: depot(structure(56, 4, 3)), size: Size.Large,
  ...
  [Kind.Pylon]: protoss('pylon', {
    name: 'Pylon', shortName: 'PYL', ...structure(20, 2, 2), size: Size.Large,
    hp: 300, shields: 300, sight: 8, minerals: 100, buildTime: sec(18), provides: supply(8),
  }),
  [Kind.Assimilator]: protoss('assimilator', {
    name: 'Assimilator', shortName: 'ASM', ...gasBuilding('protoss', 'assimilator', 450, 450), size: Size.Large,
    armor: 1, sight: 8, minerals: 100, buildTime: sec(25.2),
  }),
  [Kind.Gateway]: protoss('gateway', {
    name: 'Gateway', shortName: 'GATE', ...structure(48, 4, 3), roles: producer(structure(48, 4, 3)), size: Size.Large,
  ...
  [Kind.Forge]: protoss('forge', {
    name: 'Forge', shortName: 'FORG', ...structure(36, 3, 2), size: Size.Large,
  ...
  [Kind.PhotonCannon]: protoss('photonCannon', {
    name: 'Photon Cannon', shortName: 'CAN', ...structure(20, 2, 2), size: Size.Large,
  ...
  [Kind.CyberneticsCore]: protoss('cyberneticsCore', {
    name: 'Cybernetics Core', shortName: 'CORE', ...structure(40, 3, 2), size: Size.Large,
  ...
  [Kind.ShieldBattery]: protoss('shieldBattery', {
    name: 'Shield Battery', shortName: 'BAT', ...structure(32, 3, 2), size: Size.Large,
  ...
  [Kind.RoboticsFacility]: protoss('roboticsFacility', {
    name: 'Robotics Facility', shortName: 'ROBO', ...structure(40, 3, 2), roles: producer(structure(40, 3, 2)), size: Size.Large,
  ...
  [Kind.Stargate]: protoss('stargate', {
    name: 'Stargate', shortName: 'STAR', ...structure(48, 4, 3), roles: producer(structure(48, 4, 3)), size: Size.Large,
  ...
  [Kind.CitadelOfAdun]: protoss('citadelOfAdun', {
    name: 'Citadel of Adun', shortName: 'CITA', ...structure(32, 3, 2), size: Size.Large,
  ...
  [Kind.TemplarArchives]: protoss('templarArchives', {
    name: 'Templar Archives', shortName: 'TEMP', ...structure(32, 3, 2), size: Size.Large,
  ...
  [Kind.RoboticsSupportBay]: protoss('roboticsSupportBay', {
    name: 'Robotics Support Bay', shortName: 'RSB', ...structure(32, 3, 2), size: Size.Large,
  ...
  [Kind.Observatory]: protoss('observatory', {
    name: 'Observatory', shortName: 'OBSV', ...structure(44, 3, 2), size: Size.Large,
    hp: 250, shields: 250, armor: 1, sight: 10, minerals: 50, gas: 100, buildTime: sec(18),
    requires: [Kind.RoboticsFacility],
  }),
  [Kind.FleetBeacon]: protoss('fleetBeacon', {
    name: 'Fleet Beacon', shortName: 'BEAC', ...structure(44, 3, 2), size: Size.Large,
  ...
  [Kind.ArbiterTribunal]: protoss('arbiterTribunal', {
    name: 'Arbiter Tribunal', shortName: 'TRIB', ...structure(44, 3, 2), size: Size.Large,
  ...
  [Kind.Larva]: zerg('larva', {
    name: 'Larva', shortName: 'LARV', ...mobile(8), roles: Role.Mobile | Role.Producer, size: Size.Small,
  ...
  [Kind.Egg]: zerg('egg', {
    name: 'Egg', shortName: 'EGG', ...mobile(16), size: Size.Large,
    hp: 200, armor: 10, sight: 4, buildMethod: 'internal',
  }),
  [Kind.Drone]: zerg('drone', {
    name: 'Drone', shortName: 'DRON', ...mobile(11), roles: Role.Mobile | Role.Worker, size: Size.Small,
  ...
  [Kind.Overlord]: zerg('overlord', {
    name: 'Overlord', shortName: 'OVL', ...air(25), size: Size.Large,
  ...
  [Kind.Zergling]: zerg('zergling', {
    name: 'Zergling', shortName: 'LING', ...mobile(8), size: Size.Small,
  ...
  [Kind.Hydralisk]: zerg('hydralisk', {
    name: 'Hydralisk', shortName: 'HYD', ...mobile(10), size: Size.Medium,
  ...
  [Kind.Lurker]: zerg('lurker', {
    name: 'Lurker', shortName: 'LURK', ...mobile(16), size: Size.Large,
  ...
  [Kind.Mutalisk]: zerg('mutalisk', {
    name: 'Mutalisk', shortName: 'MUTA', ...air(22), size: Size.Small,
  ...
  [Kind.Scourge]: zerg('scourge', {
    name: 'Scourge', shortName: 'SCOU', ...air(12), size: Size.Small,
  ...
  [Kind.Guardian]: zerg('guardian', {
    name: 'Guardian', shortName: 'GUAR', ...air(22), size: Size.Large,
  ...
  [Kind.Devourer]: zerg('devourer', {
    name: 'Devourer', shortName: 'DEV', ...air(22), size: Size.Large,
  ...
  [Kind.Queen]: zerg('queen', {
    name: 'Queen', shortName: 'QUE', ...air(24), size: Size.Medium,
  ...
  [Kind.Defiler]: zerg('defiler', {
    name: 'Defiler', shortName: 'DEF', ...mobile(13), size: Size.Medium,
  ...
  [Kind.Ultralisk]: zerg('ultralisk', {
    name: 'Ultralisk', shortName: 'ULTR', ...mobile(19), size: Size.Large,
  ...
  [Kind.InfestedTerran]: zerg('infestedTerran', {
    name: 'Infested Terran', shortName: 'INF', ...mobile(8), size: Size.Small,
  ...
  [Kind.Broodling]: zerg('broodling', {
    name: 'Broodling', shortName: 'BROD', ...mobile(9), size: Size.Small,
    hp: 30, sight: 5, speed: fx(2), weapon: W(4, DamageType.Normal, 15, WR.ToxicSpores), buildMethod: 'internal',
  }),

  // Zerg buildings.
  [Kind.Hatchery]: zerg('hatchery', {
    name: 'Hatchery', shortName: 'HAT', ...structure(49, 4, 3), roles: Role.Structure | Role.ResourceDepot, size: Size.Large,
    hp: 1250, armor: 1, sight: 10, minerals: 300, buildTime: sec(120), provides: supply(1),
    buildMethod: 'morph',
  }),
  [Kind.Lair]: zerg('lair', {
    name: 'Lair', shortName: 'LAIR', ...structure(49, 4, 3), roles: Role.Structure | Role.ResourceDepot, size: Size.Large,
  ...
  [Kind.Hive]: zerg('hive', {
    name: 'Hive', shortName: 'HIVE', ...structure(49, 4, 3), roles: Role.Structure | Role.ResourceDepot, size: Size.Large,
  ...
  [Kind.CreepColony]: zerg('creepColony', {
    name: 'Creep Colony', shortName: 'CRP', ...structure(24, 2, 2), size: Size.Large,
    hp: 400, sight: 10, minerals: 75, buildTime: sec(20), requires: [Kind.Hatchery], buildMethod: 'morph',
  }),
  [Kind.SunkenColony]: zerg('sunkenColony', {
    name: 'Sunken Colony', shortName: 'SUNK', ...structure(24, 2, 2), size: Size.Large,
  ...
  [Kind.SporeColony]: zerg('sporeColony', {
    name: 'Spore Colony', shortName: 'SPOR', ...structure(24, 2, 2), size: Size.Large,
  ...
  [Kind.SpawningPool]: zerg('spawningPool', {
    name: 'Spawning Pool', shortName: 'POOL', ...structure(40, 3, 2), size: Size.Large,
  ...
  [Kind.EvolutionChamber]: zerg('evolutionChamber', {
    name: 'Evolution Chamber', shortName: 'EVO', ...structure(38, 3, 2), size: Size.Large,
    hp: 750, sight: 10, minerals: 75, buildTime: sec(25), requires: [Kind.Hatchery], buildMethod: 'morph',
  }),
  [Kind.HydraliskDen]: zerg('hydraliskDen', {
    name: 'Hydralisk Den', shortName: 'HDEN', ...structure(40, 3, 2), size: Size.Large,
  ...
  [Kind.Extractor]: zerg('extractor', {
    name: 'Extractor', shortName: 'EXT', ...gasBuilding('zerg', 'extractor', 750), size: Size.Large,
    sight: 8, minerals: 50, buildTime: sec(25), buildMethod: 'morph',
  }),
  [Kind.Spire]: zerg('spire', {
    name: 'Spire', shortName: 'SPIR', ...structure(28, 2, 2), size: Size.Large,
  ...
  [Kind.GreaterSpire]: zerg('greaterSpire', {
    name: 'Greater Spire', shortName: 'GSP', ...structure(28, 2, 2), size: Size.Large,
  ...
  [Kind.QueensNest]: zerg('queensNest', {
    name: "Queen's Nest", shortName: 'NEST', ...structure(38, 3, 2), size: Size.Large,
  ...
  [Kind.NydusCanal]: zerg('nydusCanal', {
    name: 'Nydus Canal', shortName: 'NYD', ...structure(32, 2, 2), size: Size.Large,
  ...
  [Kind.UltraliskCavern]: zerg('ultraliskCavern', {
    name: 'Ultralisk Cavern', shortName: 'UCAV', ...structure(40, 3, 2), size: Size.Large,
  ...
  [Kind.DefilerMound]: zerg('defilerMound', {
    name: 'Defiler Mound', shortName: 'DMND', ...structure(48, 4, 2), size: Size.Large,
  ...
  [Kind.InfestedCommandCenter]: zerg('commandCenter', {
    name: 'Infested Command Center', shortName: 'ICC', ...structure(58, 4, 3), roles: depot(structure(58, 4, 3)), size: Size.Large,
